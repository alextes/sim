...
impl World {
    ...
    pub fn update(&mut self, dt_seconds: f64, _current_tick: u64) {
        ...
        self.update_population(dt_seconds);
        self.update_ship_movement(dt_seconds);
    }

    fn update_population(&mut self, dt_seconds: f64) {
        // population growth
    ...
    fn update_ship_movement(&mut self, dt_seconds: f64) {
